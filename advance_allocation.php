        ...
        <form name= "form1" role="form" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                  ...
                  <div class="form-group-sm">
                  <div class="col-sm-1">
                           <input type="radio" name="adv_allo_refd" id="driver">Yes<br>
                        </div>
                                          
                        <div class="col-sm-1">
                           <input type="radio" name="adv_allo_refd" id="cleaner">No<br>
                        </div>
                    ...
                    <div class="form-group-sm">
                     ...
                     <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Payee</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Payee" onchange="" id="payee_txt" class="form-control  input-sm">
                        </div>
                        </div>
                       ...
                       <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Cash Book</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Cash Book" onchange="" id="cshbookfef_txt" class="form-control  input-sm">
                        </div>
                        
                       
                        <div class="col-sm-2">
                            <input type="text" placeholder="Cash Book" onchange="" id="cshbook_txt" class="form-control  input-sm">
                        </div>

                         <label class="col-sm-2" for="c_code">Current Rate</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Current Rate" onchange="" id="currate_txt" class="form-control  input-sm">
                        </div>
                    </div>

                    <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Type</label>
                        <div class="col-sm-2">
                          <select id="typecombo_txt" class="form-control  input-sm">
                                <option value="A">A</option>
                                <option value="B">B</option>
                          </select>
                        </div>
                       <div class="col-sm-2">
                            <input type="text" placeholder="Type" onchange="" id="type_txt" class="form-control  input-sm">
                        </div>

                         <label class="col-sm-2" for="c_code">Cheque No.</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Cheque No." onchange="" id="cheno_txt" class="form-control  input-sm">
                        </div>
                     ...
                     <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">A/C Payee</label>
                        <div class="col-sm-2">
                          <select id="acpayeecombo_txt" class="form-control  input-sm">
                                <option value="A">A</option>
                                <option value="B">B</option>
                          </select>
                        </div>
                       <div class="col-sm-2">
                            <input type="text" placeholder="A/C Payee" onchange="" id="acpayee_txt" class="form-control  input-sm">
                        </div>
                    ...
                    <div class="form-group-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="Advanced No." onchange="" id="advno_txt" class="form-control  input-sm">
                        </div>
                        ...
                        <div class="col-sm-2">
                         ...
                         <label class="col-sm-2" for="c_code">Advanced</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Advanced" onchange="" id="cbook_txt" class="form-control  input-sm">
                        </div>
                   ...
                   <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Balance Adv. Amount</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Balance Adv. Amount" onchange="" id="baladvamt_txt" class="form-control  input-sm">
                        </div>
                        <label class="col-sm-2" for="c_code">Original Adv. Amount</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Advanced Currency" onchange="" id="advcurr_txt" class="form-control  input-sm">
                        </div>
                         ...
                         <label class="col-sm-2" for="c_code">Original Adv. Amount</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Original Adv. Amount" onchange="" id="oriadvamt_txt" class="form-control  input-sm">
                        </div>
                     ...
                     <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Bank Charges</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Bank Charges" onchange="" id="baladvamt_txt" class="form-control  input-sm">
                        </div>

                        <label class="col-sm-2" for="c_code">Gain/Loss</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Gain/Loss" onchange="" id="gainloss_txt" class="form-control  input-sm">
                        </div>
                      </div>
