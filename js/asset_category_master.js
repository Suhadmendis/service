...
function newent() {
    ...
    document.getElementById('depre_rate').value = "";
    document.getElementById('depre_years').value = "";
    document.getElementById('depre_months').value = "";
...
function getdt() {
    ...
    var url = "asset_category_master_data.php";
...
function assign_dt() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        document.getElementById('catcode').value = XMLAddress1[0].childNodes[0].nodeValue;
...
function save_inv()
{
    ...
    if (document.getElementById('itemcat').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Item Category Not Entered</span></div>";
        return false;
    }
    ...
    url = url + "&itemcat=" + document.getElementById('itemcat').value;
    url = url + "&depre_rate=" + document.getElementById('depre_rate').value;
    url = url + "&depre_years=" + document.getElementById('depre_years').value;
    url = url + "&depre_months=" + document.getElementById('depre_months').value;
