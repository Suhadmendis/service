...
function newent() {
    ...
    document.getElementById('assetname_txt').value = "";
    document.getElementById('assetcatgry_txt').value = "";
    document.getElementById('remk_txt').value = "";
...
function getdt() {
    ...
    var url = "fixed_asset_master_data.php";
...
function assign_dt() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        document.getElementById('assetcode').value = XMLAddress1[0].childNodes[0].nodeValue;
...
function save_inv()
{
    ...
    url = url + "?Command=" + "save_item";
	 ...
	 url = url + "&assetcode=" + document.getElementById('assetcode').value;
     url = url + "&assetname_txt=" + document.getElementById('assetname_txt').value;
     url = url + "&assetcatgry_txt=" + document.getElementById('assetcatgry_txt').value;
     url = url + "&remk_txt=" + document.getElementById('remk_txt').value;
