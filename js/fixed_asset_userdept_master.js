...
function newent() {
    ...
    document.getElementById('userdept_txt').value = "";
...
function getdt() {
    ...
    var url = "fixed_asset_user_dept_master_data.php";
...
function save_inv()
{
    ...
    url = url + "&userdept_txt=" + document.getElementById('userdept_txt').value;
