...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Asset Category Master</b></h3>
        </div>
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="Item Ref."  id="catcode" class="form-control  input-sm  " disabled="">
                        </div>
                        ...
                        <div class="form-group-sm">
                            ...
                            <div class="col-sm-2">
                                <input type="text" placeholder="Item Category"  id="itemcat" class="form-control  input-sm">
                            </div>
                            <div class="form-group"></div>
                            <div class="form-group-sm">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="text" placeholder="Depreciation Rate Per Year"  id="depre_rate" class="form-control  input-sm">
                                </div>

                                <div class="form-group"></div>
                                <div class="form-group-sm">
                                    <label class="col-sm-2" for="c_code">Depreciation Years</label>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="Depreciation Years"  id="depre_years" class="form-control  input-sm">
                                    </div>
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="Depreciation Months"  id="depre_months" class="form-control  input-sm">
                                    </div>
                    ...
                    <script src="js/asset_category_master.js"></script>
