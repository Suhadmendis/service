...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Advanced Refund</b></h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                    ...
                    <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Type (Cash/Cheque)</label>
                        <div class="col-sm-2">
                        <input type="text" placeholder="Type" onchange="" id="typeref_txt" class="form-control  input-sm">
                        </div>
                       <div class="col-sm-2">
                   ...
                   <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Balance Adv. Amount (LKR)</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Balance Adv. Amount" onchange="" id="baladvamt_txt" class="form-control  input-sm">
                        </div>
                        <label class="col-sm-2" for="c_code">Original Adv. Amount (LKR)</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Original Adv. Amount" onchange="" id="orgadvamt_txt" class="form-control  input-sm">
                        </div>

                         <label class="col-sm-2" for="c_code">Balance to be refund (LKR)</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Balance to be refund" onchange="" id="baltorefamt_txt" class="form-control  input-sm">
                        </div>
                    ...
                    <div class="form-group-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="Being recorded advance refund" onchange="" id="remk_txt" class="form-control  input-sm">
                        </div>
						</div>
                      </div>
