...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Fixed Asset User Department</b></h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                    ...
                    <div class="col-sm-2">
                        <input type="text" placeholder="User Department" onchange="" id="userdept_txt" class="form-control  input-sm">
                    </div>
...
<script src="js/fixed_asset_userdept_master.js"></script>
